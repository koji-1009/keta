...
void main() {
  group('response descriptions are RFC 9110 reason phrases, not a fixed OK', () {
  ...
  group('a failure may declare a non-JSON media type', () {
      ...
      final app = App<Ignored>()
        ..get(
          ...
          doc: const RouteDoc(
            success: Success(),
            failureResponses: {
              422: Failure(errorSchema, contentType: 'application/problem+json'),
            },
          ),
        );
    ...
    test('a failure value that is neither Schema nor Failure is a hard error', () {
