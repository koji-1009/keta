...
class AlgCase({
  ...
  required final JwsAlgorithm alg,
  required final Uint8List Function(Uint8List signingInput) sign,
  required final Map<String, Object?> Function(String kid) jwk,
  required final Map<String, Object?> Function(String kid) wrongJwk,
});
...
void main() {
  ...
  test('an ES256 signature of the wrong size → JwtBadSignature, not an exception', () async {
  ...
  test('the identity key cache: repeated verify with the same Jwk works', () async {
