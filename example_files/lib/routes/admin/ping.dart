...
///
/// The 403 is part of the contract, so it is declared: it comes from
/// requireAdmin, not from the security gate, and a status the gate never
...
Response get(Context<Env> c) {
  // Authorization is the handler's or a middleware's business: the gate answers
  // "who are you", this answers "may you". Keeping them apart is why 401 and
